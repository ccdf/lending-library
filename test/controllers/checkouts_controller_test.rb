...
class CheckoutsControllerTest < ActionController::TestCase
  ...
  test "should create checkout" do
    assert_difference('Checkout.count') do
      post :create, checkout: { available: @checkout.available, book_id: @checkout.book_id, checkin_date: @checkout.checkin_date, checkout_date: @checkout.checkout_date, user_id_id: @checkout.user_id_id }
    end
  ...
  test "should update checkout" do
    patch :update, id: @checkout, checkout: { available: @checkout.available, book_id: @checkout.book_id, checkin_date: @checkout.checkin_date, checkout_date: @checkout.checkout_date, user_id_id: @checkout.user_id_id }
    assert_redirected_to checkout_path(assigns(:checkout))
  end
